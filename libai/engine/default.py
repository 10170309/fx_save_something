...
class DefaultTrainer(TrainerBase):
    ...
    def get_batch(
        ...
        if mixup_func is not None:
            ...
            #flow.profiler.range_pop()
            #flow.profiler.range_push('get_images')
            data.get("images").tensor = images
            #flow.profiler.range_pop()
            #flow.profiler.range_push('get_labels')
        ...
        for key, value in data.get_fields().items():
            flow.profiler.range_push('value.to_global')
