...
class TrainerBase:
    ...
    def write_metrics(
        ...
        #flow.profiler.range_push('get metric')
        metrics_dict = {
        ...
        #flow.profiler.range_push('is_main_process')
...
class EagerTrainer(TrainerBase):
    ...
    def run_step(self, get_batch: Callable, input_placement_device: str = "cuda"):
        ...
        flow.profiler.range_push('forward_backward')
        flow.profiler.range_push('forward_step')
        # If you want to do something with the data, you can wrap the dataloader.

        flow.profiler.range_push('next')

        data = next(self._data_loader_iter)

        flow.profiler.range_pop()

        flow.profiler.range_push('get batch')
        ...
        flow.profiler.range_push('model')
        ...
        flow.profiler.range_push('backward_step')

        losses.backward()

        flow.profiler.range_pop()
        flow.profiler.range_pop()
        flow.profiler.range_push('write_matrics')
        
        self.write_metrics(loss_dict, data_time)

        flow.profiler.range_pop()

        flow.profiler.range_push('optimiser')
