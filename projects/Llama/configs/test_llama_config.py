...
weight_decay = 0.1
learning_rate = 5e-5
pretrained_model_path = "/data/hf_models/meta-llama/Llama-2-7b-hf"

data_prefix = "/home/fuxu/work/new_libai/libai-test_llama/datasets/loss_compara_content_sentence"
...
train.update(
    dict(
        output_dir="/data0/home/fuxu/libai/new5/sft_result",
